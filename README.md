...
This is not a foundation-only placeholder. The application includes public websites, intake, CRM, estimates, jobs, field workflow, invoices, payments, expenses, payroll, reports, financial intelligence, reviews, marketing, and owner intelligence (Business Health / BSOS Coach). Banking and accounting adapters stay disconnected.
