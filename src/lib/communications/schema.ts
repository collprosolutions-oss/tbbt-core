 ...
 *   prisma/migrations/20260925220000_communications_department/migration.sql
 * Additive PhoneInteraction FKs:
 *   prisma/migrations/20260925230000_phone_interaction_relations/migration.sql
 *
...
export const COMMUNICATIONS_DEPARTMENT_MIGRATIONS = [
  "20260925220000_communications_department",
  "20260925230000_phone_interaction_relations",
] as const;
