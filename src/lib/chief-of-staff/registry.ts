...
export const SPECIALIST_REGISTRY: readonly SpecialistRegistryEntry[] = [
  ...
  },
  {
    ...
    purpose:
      "Explain recorded Business Protection vault, checklist, agreement, and e-sign metadata. Read/explain only. Not a second legal engine.",
    enabled: true,
    ...
    forbiddenBehavior: [
      ...
      "owner-review-mutation",
      "legal-acknowledgment-mutation",
      "e-sign",
      "reminders",
      "send-communications",
      "propose-ai-action",
