...
export const SPECIALIST_REGISTRY: readonly SpecialistRegistryEntry[] = [
  ...
  },
  {
    ...
    purpose:
      "Explain recorded Business Protection, Business Vault, and Agreement Coach workflow truth. Read/explain only. Not a second Protection engine, Vault system, Agreement Coach, legal engine, or e-sign system.",
    enabled: true,
    requiredRoleCapability: CAPABILITIES.MANAGE_BUSINESS_PROTECTION,
    requiredProductCapability: null,
    readScope: "business-protection-vault",
    approvalClass: COS_APPROVAL_CLASS,
    forbiddenBehavior: [
      "invoke-specialist",
      "invoke-agreement-coach-ai",
      "create-vault-record",
      "update-vault-record",
      "upload-vault-document",
      "create-agreement",
      "save-agreement-answers",
      "generate-agreement-draft",
      "save-agreement-draft",
      "mark-owner-reviewed",
      "acknowledge-legal-review",
      "mark-agreement-ready",
      "mark-agreement-sent",
      "complete-agreement",
      "sign-agreements",
      "connect-esign",
    ...
    deepLoader: "business-protection-bounded-projection",
  },
] as const;
