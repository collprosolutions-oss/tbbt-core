...
export const FOUNDER_REGIONS: Record<FounderPageKey, readonly FounderRegionDef[]> = {
  ...
  marketing: [
    { id: "summary", label: "Marketing Summary", kind: "kpi" },
    { id: "nav", label: "Marketing Navigation", kind: "tabs", hasTitle: true },
    {
      id: "opportunities",
    ...
    { id: "content", label: "Content Workspace", kind: "table" },
    {
      id: "calendar",
    ...
    {
      id: "rail",
      label: "Right Rail / Growth Opportunities",
      kind: "panel",
      hasTitle: true,
      hasBody: true,
      hasButtons: true,
  ...
  knowledge: [
    { id: "summary", label: "Knowledge Summary", kind: "kpi" },
    { id: "nav", label: "Knowledge Navigation / Filters", kind: "tabs", hasTitle: true },
    {
      id: "list",
