...
export const CAPABILITIES = {
  ...
  /**
   * Owner/admin Reviews workspace: review opportunities from completed
   * jobs, request records, received-review records, and response drafts.
   * MEMBER must never receive this -- Reviews holds business-wide
  ...
  /**
   * Owner/admin Knowledge Hub: durable operational knowledge, provenance,
   * and trust state over existing TBBT records. MEMBER must never receive
   * this -- Knowledge Hub holds business-wide operational intelligence,
 ...
 * Reports, Marketing, Reviews, Pipeline, Knowledge, Communications, Services, Time Cards, Payroll, Expenses, Settings).
 *
