...
export function PublicServicesBrowser({
  ...
  function setQty(id: string, raw: string) {
    ...
    setSelected((current) =>
      setSelectedQuantity(current, id, parsed ?? 1),
    );
  }
  ...
  return (
    <div className="public-services-layout">
      ...
      <div className="public-services-body">
        <aside>
              ...
              <ul>
                {selectedRows.map((item) => {
                  ...
                  return (
                    <li key={item.id}>
                      <span>
                        {formatWorkQuantityLabel(qty, item.name)}
                      </span>
            ...
            {group.items.map((item) => {
              ...
              return (
                <div key={item.id} className="public-service-row" data-selected={checked ? "true" : "false"}>
                  <div className="public-service-row-main">
                    <button
                      type="button"
          ...
          <button
            ...
            onClick={() =>
              setSelected((current) => ({
                ...
                otherQuantity: current.includeOther ? 1 : coerceRequestQuantity(current.otherQuantity, 1),
              }))
            }
